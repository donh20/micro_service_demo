...
INSERT INTO x_product.products (id,name,price,stock) VALUES (1,'显示器', 1999,2); # 插入一条产品的库存
...
INSERT INTO  x_account.accounts (id,name,balance) values (1,'John',300);
...
select * from x_account.accounts;

select  * from x_product.products;

select * from x_order.orders;
